...
|----------------|---------|-------------|
| **CLI Tool Only** | `uv tool install specify-cli --force --from git+https://github.com/bigsmartben/bb-spec-kit.git` | Get latest CLI features without touching project files |
...
```bash
uvx --from git+https://github.com/bigsmartben/bb-spec-kit.git specify init --here --ai copilot
```
