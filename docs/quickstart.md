...
```bash
uvx --from git+https://github.com/bigsmartben/bb-spec-kit.git specify init <PROJECT_NAME> --script ps  # Force PowerShell
uvx --from git+https://github.com/bigsmartben/bb-spec-kit.git specify init <PROJECT_NAME> --script sh  # Force POSIX shell
```
