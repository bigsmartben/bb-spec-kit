...
- This requirement applies to any `Existing` claim and to all repo-derived entries referenced in analysis.
...
- If required evidence remains unavailable after fallback, use `TODO(<FIELD>): ISS-MCP/local evidence missing` and list it in the analysis report.
